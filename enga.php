...
<div class="row container-dark">
  <h1 class="col-md-11 col-md-offset-1">Nos<br />Engagement</h1>
</div>
<div class="row container-dark">
  <div class="background-full"></div>
  <blockquote class="col-md-10 col-md-offset-1 pointed">
    <br /><br />
    Chacun de nos experts s’engage, en rejoignant le groupe Gicram, à porter les valeurs qui ont fondé l’esprit même de Gicram.
  Ces valeurs de sérieux, d’engagement et de réactivité sont les fondements historiques de notre sens du service et de notre professionnalisme dans chaque projet de collaboration.
  Ce sont ces valeurs fondamentales qui guident notre action et notre relation client jour après jour : des clients qui nous font confiance et nous confient leurs projets depuis plus de 40 ans maintenant. Elles sont les garantes du bon déroulement de chaque projet et de sa réussite.
  <br /><br />
  <b>Laurent Horbette, directeur général de Gemfi,
  et copilote de la commission « Développement durable » d’Afilog</b>
  <br/><br />
  </blockquote>
</div>
...
<!-- Double col -->
  <div class="row container-dark">
    ...
    <blockquote class="col-md-10 col-md-offset-1 pointed">
      <br /><br />
      Nous nous voulons à la pointe,<br /> non pas de l’effet de mode écologique et médiatique du « business vert », mais de l’évolution des technologies, de la réglementation des modèles constructifs et de la qualité des lieux de travail. Pour nous, ces nouvelles technologies « vertes » ne sont pas un simple positionnement opportuniste, mais un véritable outil d’évolution. L’innovation en la matière n’est pas un surcoût impossible à mettre en œuvre, mais un puissant avantage pour se différencier et être compétitif.<br /><br />
    <b>Laurent Horbette, directeur général de Gemfi,
et copilote de la commission « Développement durable » d’Afilog</b>
    <br/><br />
    </blockquote>
  ...
  <div class="row triple-container container-dark">
    ...
    <div class="col-md-4 background-body text-center container-dark">
      <div class="background-full-vert-light"></div>
      <h4 class="h4-double">cible B</h4>
      <span>Adaptation du bâtiment<br /> au process</span>
      </div>
...
applicables aux bâtiments logistiques : « Charte AFILOG : première charte développement durable applicable aux plates-formes logistiques       </h6>
    </div>
  </div>
