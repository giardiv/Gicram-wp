      ...
      <div id="carousel-example-generic" class="carousel slide carousel-v" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="item active">
              <iframe id="video-ss-1" class="video-ss" src="https://player.vimeo.com/video/158933289?title=0&amp;byline=0&amp;portrait=0" class="col-md-12" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen=""></iframe>
              <div class="carousel-caption" data-id="1">
                  <div class="bg-white"></div>
                  <h3 class="caption-text">Citation</h3>
              </div>
            </div>
            <div class="item">
                <iframe id="video-ss-2" class="video-ss" src="https://player.vimeo.com/video/158933289?title=0&amp;byline=0&amp;portrait=0" class="col-md-12" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen=""></iframe>
              <div class="carousel-caption" data-id="2">
                  <div class="bg-white"></div>
                  <h3 class="caption-text">Citation</h3>
              </div>
            </div>
            <div class="item">
                <iframe id="video-ss-3" class="video-ss" src="https://player.vimeo.com/video/158933289?title=0&amp;byline=0&amp;portrait=0" class="col-md-12" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen=""></iframe>
                <div class="carousel-caption" data-id="3">
                    <div class="bg-white"></div>
                    <h3 class="caption-text">Citation</h3>
                </div>
            </div>
